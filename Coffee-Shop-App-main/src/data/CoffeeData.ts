const CoffeeData = [
  {
    ...
    prices: [
      {size: 'S', price: '10.000', currency: 'Rp'},
      {size: 'M', price: '20.000', currency: 'Rp'},
      {size: 'L', price: '30.000', currency: 'Rp'},
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    id: 'C2',
    name: 'Kopi Almond',
    description: `Kopi Almond, or almond coffee, is a delightful beverage that combines the robust flavors of coffee with the subtle, nutty taste of almonds. This drink has gained popularity among coffee enthusiasts looking for a unique twist on their traditional cup of joe`,
    roasted: 'Medium Roasted',
    ...
    prices: [
      {size: 'S', price: '10.000', currency: 'Rp'},
      {size: 'M', price: '10.000', currency: 'Rp'},
      {size: 'L', price: '10.000', currency: 'Rp'},
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    id: 'C3',
    name: 'Kopi Susu',
    description: `Kopi Susu, translating to "coffee with milk" in Indonesian, is a beloved traditional beverage that combines rich, bold coffee with sweetened condensed milk. This drink is popular in Indonesia and is enjoyed by coffee lovers for its creamy texture and balanced sweetness.`,
    roasted: 'Medium Roasted',
  ...
  },
  {
    id: 'C4',
    name: 'Susu Kedelai',
    description: `Susu Kedelai, which means "soy milk" in Indonesian, is a plant-based milk made from soybeans. It's a popular beverage in many parts of the world, including Indonesia, due to its numerous health benefits and versatility.`,
    roasted: 'Medium Roasted',
  ...
  },
  {
    id: 'C5',
    name: 'Susu Matcha',
    description: `Susu Matcha, or matcha milk, is a delightful beverage that combines the rich, earthy flavors of matcha green tea with the creamy texture of milk. This drink is enjoyed both hot and cold, offering a refreshing and energizing experience.`,
    roasted: 'Medium Roasted',
