const BeansData = [
  {
    ...
    ingredients: 'Aceh',
    special_ingredient: 'From Aceh',
    prices: [
      {size: '250gm', price: '40.000', currency: 'Rp'},
      {size: '500gm', price: '80.000', currency: 'Rp'},
      {size: '1Kg', price: '150.000', currency: 'Rp'},
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    ...
    special_ingredient: 'From Aceh',
    prices: [
      {size: '250gm', price: '50.000', currency: 'Rp'},
      {size: '500gm', price: '90.000', currency: 'Rp'},
      {size: '1Kg', price: '170.000', currency: 'Rp'},
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    ...
    prices: [
      {size: '250gm', price: '70.000', currency: 'Rp'},
      {size: '500gm', price: '130.000', currency: 'Rp'},
      {size: '1Kg', price: '250.000', currency: 'Rp'},
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    ...
    special_ingredient: 'From Malaysia',
    prices: [
      {size: '250gm', price: '80.000', currency: 'Rp'},
      {size: '500gm', price: '150.000', currency: 'Rp'},
      {size: '1Kg', price: '300.000', currency: 'Rp'},
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
